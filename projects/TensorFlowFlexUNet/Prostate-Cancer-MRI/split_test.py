...
# 2025/09/13 Modified to split PNG files.
...
if __name__ == "__main__":
  try:
    images_dir = "./Prostate-Cancer-MRI-ImageMask-Dataset-V2/test/images/"
    masks_dir  = "./Prostate-Cancer-MRI-ImageMask-Dataset-V2/test/masks/"
    output_dir = "./new_mini_test/"
